...
function calcularTabla() {
  ...
  if (inputTabla > 0) {
    ...
    do {
      ...
      tabla += `<div class="col-md-1 colum"> <h3> ${contador} </div>`;
      tabla += `<div class="col-md-1 colum-green"<h3>X</div>`;
      tabla += `<div class="col-md-1 colum"> <h3> ${inputTabla} </div>`;
      tabla += `<div class="col-md-1 colum-green"<h3>=</div>`;
      tabla += `<div class="col-md-1 colum"> <h3> ${resultado} </div>`;
      tabla += "</div>";
